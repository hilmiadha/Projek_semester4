...
<body>
	<div class="container-fluid">
		<div class="row top" style="background-color: #508A8B;">
			<center>
				<div class="col-md-4" style="padding: 3px;">
					<span> <i class="glyphicon glyphicon-earphone"></i> +6288232847289</span>
				</div>


				<div class="col-md-4" style="padding: 3px;">
					<span><i class="glyphicon glyphicon-envelope"></i> sakacatering@gmail.com</span>
				</div>


				<div class="col-md-4" style="padding: 3px;">
					<span>Saka Catering</span>
				</div>
			</center>
		</div>
	</div>
	...
	<nav class="navbar navbar-default" style="padding: 5px;">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#" style="color:#508A8B"><b>SAKA CATERING</b></a>
			</div>
