...
<div class="container" style="padding-bottom: 300px;">
	<h2 style=" width: 100%; border-bottom: 4px solid #508A8B"><b>Keranjang</b></h2>
	<table class="table table-striped">
		...
		?>
				...
				?>
					...
					<tr>
						<td colspan="7" style="text-align: right; font-weight: bold;"><a href="index.php" class="btn btn-success">Lanjutkan Belanja</a> <a href="checkout.php?kode_cs=<?= $kode_cs; ?>" class="btn btn-primary">Pesan Sekarang</a></td>
					</tr>
			<?php
			} else {
				echo "
