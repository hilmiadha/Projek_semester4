...
?>
<div class="container">
	<h2 style=" width: 100%; border-bottom: 4px solid #508A8B"><b>Detail produk</b></h2>
			...
			<form action="proses/add.php" method="GET">
				...
				<table class="table table-striped">
					<tbody>
						...
						<tr>
							<td><b>Harga</b></td>
							<td>Rp.<?= number_format($row['harga']); ?>/ Kotak</td>
						</tr>
						<tr>
							<td><b>Deskripsi</b></td>
							<td><?= $row['deskripsi'];  ?></td>
						...
						<tr>
							<td><b>Jumlah</b></td>
							<td><input class="form-control" type="number" min="1" name="jml" value="1" style="width: 155px;">*Minimal pembelian 50</td>
						</tr>
					</tbody>
				</table>
				<?php
