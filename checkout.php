...
<div class="container" style="padding-bottom: 200px">
	<h2 style=" width: 100%; border-bottom: 4px solid #508A8B"><b>Order Pesanan</b></h2>
	<div class="row">
		<div class="col-md-6">
	...
	<form action="proses/order.php" method="POST">
		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					<label for="exampleInputPassword1">Jam Pengiriman</label>
					<input type="text" class="form-control" id="exampleInputPassword1" placeholder="*Tidak mepet jam acara" name="prov">
				</div>
			</div>
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="exampleInputPassword1" placeholder="*Tidak kurang dari 1x24 jam dari pemesanan" name="kota">
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="exampleInputPassword1" placeholder="*Alamat lengkap" name="almt">
				</div>
			</div>
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="exampleInputPassword1" placeholder="No Telepon" name="kopos">
				</div>
			</div>
		</div>
